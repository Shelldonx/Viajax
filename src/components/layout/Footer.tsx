      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6">
        <div className="grid gap-8 md:grid-cols-4">
          ...
          <div className="md:col-span-2">
            ...
            <p className="mt-3 max-w-md text-sm text-gray-500">
              Marketplace open source para creators venderem eBooks digitais. Taxa de apenas 3% — a mais baixa do mercado. Payouts em USDC na Solana.
            </p>
          </div>

          {/* Links */}
          <div>
            <h4 className="mb-3 text-sm font-semibold text-gray-300">Plataforma</h4>
            <ul className="space-y-2 text-sm">
              ...
              <li><Link href="/dashboard/products/new" className="text-gray-500 hover:text-teal-400 transition-colors">Vender eBook</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-8 flex flex-col items-center justify-between gap-4 border-t border-gray-800/50 pt-8 sm:flex-row">
          <p className="text-xs text-gray-600">
            © {new Date().getFullYear()} Viajax — Shelldon. Todos os direitos reservados.
          </p>
          <p className="flex items-center gap-1 text-xs text-gray-600">
            Feito com <Heart className="h-3 w-3 text-red-500" /> em Solana Mainnet
          </p>
        </div>
      </div>
    </footer>
